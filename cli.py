...
if __name__ == "__main__":
    cli([
        "--model-file", "/data_1/xuzf/workspace/opensource/OpenEL/luke/data/luke_large_ed.tar.gz",
        "--output-dir", "/data_1/xuzf/workspace/opensource/OpenEL/luke/data/entity_disambiguation/output",
        "entity-disambiguation", "run",
        "--data-dir", "/data_1/xuzf/workspace/opensource/OpenEL/luke/data/entity_disambiguation",
        "--no-train",
        "--do-eval",
        "--comet-project-name", "luke_ed_cli",
        "--comet-offline-dir", "/data_1/xuzf/workspace/opensource/OpenEL/luke/data/entity_disambiguation/output"
    ])
