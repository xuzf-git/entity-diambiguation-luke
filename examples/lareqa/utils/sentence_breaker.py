...
class SQuADSentenceTokenizer(SentenceTokenizer):
    ...
    def span_tokenize(self, text: str) -> List[Tuple[int, int]]:
        ...
        uni_text = re.sub(r"\n", r" ", text)  # Remove pre-existing newlines.
...
def _sed_do_sentence_breaks(uni_text):
    ...
    txt = re.sub(r"(\.) (In|On|By|During|After|Under|Although|Yet|As |Several" r"|According to) ", r"\1\n\2 ", txt)
